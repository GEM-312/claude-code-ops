...
| [2026-06-29](./2026-06-29.md) | v2.1.186–2.1.195; ✅ RAA PRs #10/#19/#20 all merged — backlog cleared; skill frontmatter `default-enabled`/`fallback` keys; `sandbox.credentials` setting; `/rewind`; 37% CPU reduction streaming; hook comma-matcher + hyphenated-matcher fixes; 2 safe PRs ([RAA #21](https://github.com/GEM-312/RenaissanceArchitectAcademy/pull/21) + [ChefAcademy #6](https://github.com/GEM-312/ChefAcademy/pull/6): `attribution.sessionUrl: false`) |
